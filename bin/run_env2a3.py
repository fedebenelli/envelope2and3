...
from make_envelout import make_envel
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 2:
        ...
        elif sys.argv[2] == "independent":
            envelopes = []
            for file in os.listdir("independent"):
                envelopes.append(os.path.join("independent", file))
            envelopes = sorted(envelopes)
            make_figure(envelopes, "independent")
